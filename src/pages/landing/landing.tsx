...
function Landing() {
  return (
    <>
      <div className="bg-[#8a0000] flex flex-col md:flex-row md:justify-center gap-4 md:gap-4 lg:gap-10 px-4 md:px-6 lg:px-10 py-6 md:py-8 max-w-full overflow-x-hidden">
        ...
        <div className="bg-[#121212] w-full md:w-1/2 lg:w-2/3 rounded-[30px] shadow-[0_2px_4px_white] self-center p-4 md:p-6">
          ...
          <div className="bg-[#f8ede3] rounded-lg overflow-hidden">
            <div className="text-center p-2">
              ...
              <p className="text-lg">Ryno Erasmus piel</p>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-2 justify-center items-center mt-10">
            ...
            <Link
              to={"/contact"}
              className="min-w-26 px-5 h-14 text-center bg-[#8a0000] text-white rounded-[20px] flex items-center justify-center hover:bg-green-600"
            >
              Hire Me
            </Link>
            <a
